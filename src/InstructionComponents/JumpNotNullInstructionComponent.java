...
public class JumpNotNullInstructionComponent extends InstructionComponent {
	private static final long serialVersionUID = 1L;

	JLabel label;
	
	public JumpNotNullInstructionComponent(){
		setDisplayedText(LocalizedStrings.instructionJumpNotNull);
